...
parser.add_argument('--K', metavar='K', default=512, type=int,
...
def main():
    ...
    sketch_batch_size = args.batch_size // 3
    ...
    train_loader = DataLoader(dataset=sketchy_train, batch_size=sketch_batch_size, shuffle=True, num_workers=3, drop_last=True)
    ...
    train_loader_ext = DataLoader(dataset=sketchy_train_ext, \
                                  batch_size=photo_batch_size, shuffle=True, num_workers=3, drop_last=True)
