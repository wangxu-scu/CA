...
from  tool import occumpy_mem, compressITQ
...
SCKEY = "SCT58224TtooU36R5d6Dwfmn2F2jD7jTy" # the sckey you get from http://sc.ftqq.com/3.version
...
def prepare_features():
    ...
    zero_loader = DataLoader(dataset=tuberlin_zero, batch_size=args.batch_size, shuffle=False, num_workers=0)
