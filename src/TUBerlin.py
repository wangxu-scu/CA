...
class TUBerlinDataset(Dataset):
    def __init__(self, split='train',
                 ...
                 cid_mask = False, transform=None, contrastive_transform=None, aug=False, shuffle=False, first_n_debug=9999999):
    ...
    def __getitem__(self, idx):
        ...
        if self.contrastive_transform is not None:
            img1 = self.contrastive_transform[0](img)
            img2 = self.contrastive_transform[1](img)
        ...
        if self.cid_mask:
            ...
            if self.contrastive_transform is not None:
                return img, img1, img2, label, mask, wv
            else:
                return img, label, mask, wv

        else:
            if self.contrastive_transform is not None:
                return img, img1, img2, label, wv
            else:
                return img, label, wv
